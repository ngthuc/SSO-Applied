...
/**
 * Sets the manageCustomerController ID for SCAYT. Required for migration from free,
 * ad-supported version to paid, ad-free version.
 * @name CKEDITOR.config.scayt_customerid
 * @type String
 * @default <code>''</code>
 * @example
 * // Load SCAYT using my manageCustomerController ID.
 * config.scayt_customerid  = 'your-encrypted-manageCustomerController-id';
 */
